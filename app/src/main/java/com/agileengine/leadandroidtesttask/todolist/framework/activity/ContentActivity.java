...
public abstract class ContentActivity<T extends Fragment> extends AppCompatActivity implements ToolbarGetter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mContentFragment = (T) getFragmentManager().findFragmentById(R.id.container);
        }
